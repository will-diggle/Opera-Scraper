...
h1{font:400 clamp(30px,4.6vw,46px)/1.1 "Iowan Old Style","Palatino Linotype",
  Palatino,Georgia,serif;margin:14px 0 0;text-wrap:balance;letter-spacing:-.01em}
.sub{color:var(--ink-soft);margin:12px 0 0;max-width:62ch;font-size:15.5px}
.stats{display:flex;flex-wrap:wrap;gap:26px;margin-top:26px;
  padding-top:22px;border-top:1px solid var(--line)}
.stat b{display:block;font:400 27px/1 "Iowan Old Style",Georgia,serif;
